...
do
        ...
        do
                ...
                ssh endpoint0@192.168.122.16 -i /home/f20190095/.ssh/id_rsa_benchmark "echo \$(python3 write.py) >> 4_node_rf1.txt; exit;"
        done
        ssh endpoint0@192.168.122.16 -i /home/f20190095/.ssh/id_rsa_benchmark "echo >> 4_node_rf1.txt; exit;"
done
