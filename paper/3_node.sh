...
do
        ...
        do
                ...
                tcset --add ens2 --delay $latency --loss $packetLoss --network 192.168.122.11;exit;"
                ...
                tcset --add ens2 --delay $latency --loss $packetLoss --network 192.168.122.12;exit;"

                ssh endpoint0@192.168.122.16 -i /home/f20190095/.ssh/id_rsa_benchmark "echo \$(python3 write.py) >> 3_node_rf3.txt; exit;"
        done
        ssh endpoint0@192.168.122.16 -i /home/f20190095/.ssh/id_rsa_benchmark "echo >> 3_node_rf3.txt; exit;"
done
